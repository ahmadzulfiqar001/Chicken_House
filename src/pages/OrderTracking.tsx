      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <form onSubmit={handleSearch} className="group relative">
            <div className="absolute left-6 top-1/2 -translate-y-1/2 text-muted transition-colors group-focus-within:text-primary">
              <Search size={24} />
            </div>
            <input
              type="text"
              ...
              className="w-full rounded-full border-2 border-surface-strong bg-white py-6 pl-16 pr-40 text-xl font-bold text-dark shadow-xl shadow-dark/5 outline-none transition-all focus:border-primary"
            />
            <button
              type="submit"
              disabled={!orderId || isSearching}
              className="absolute bottom-3 right-3 top-3 flex items-center gap-2 rounded-full bg-primary px-10 font-bold text-white transition-colors hover:bg-primary-strong disabled:opacity-50"
            >
